...
namespace TPD.Arena
{
    ...
    {
        public static List<TimelineEvent> Simulate(
            AbilityDataSO[] player1Abilities,
            AbilityDataSO[] player2Abilities,
            AbilityDataSO player1AutoAttack,
            AbilityDataSO player2AutoAttack,
            int maxHealth = 100)
        {
            return Simulate(player1Abilities, player2Abilities, player1AutoAttack, player2AutoAttack, maxHealth, maxHealth);
        }
            ...
            int p2MaxHealth)
        {
            ...
            AbilityDataSO[] p1Full = AddAutoAttack(player1Abilities, player1AutoAttack);
            AbilityDataSO[] p2Full = AddAutoAttack(player2Abilities, player2AutoAttack);
            CharacterSimState p1 = new CharacterSimState(p1Full, p1MaxHealth);
            CharacterSimState p2 = new CharacterSimState(p2Full, p2MaxHealth);
                    ...
                    case SimEvent.SimEventType.Hit:
                        ...
                        switch (dataHit.type)
                        {
                            ...
                            case AbilityType.Heal:
                                ...
                                ch.health = Mathf.Min(ch.health + heal, ch.maxHealth);
        ...
        public static AbilityDataSO GetAbilityByName(string abilityName, AbilityDataSO[] playerAbilities, AbilityDataSO autoAttackData)
        {
            ...
            foreach (var a in fullList) if (a != null && a.abilityName == abilityName) return a;
            return null;
        }
    }
}
